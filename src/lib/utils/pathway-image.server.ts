...
/**
 * Intelligently resolves pathway cover image URLs from various sources (server-side):
 ...
 */
export async function getPathwayImageUrl(path: string | null | undefined): Promise<string> {
